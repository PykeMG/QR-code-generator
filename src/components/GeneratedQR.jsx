    ...
    const shareQRcode = () => {
        if (navigator.share) {
            ...
            navigator.share({
                ...
                text: 'QR code generated by PykeCatL',
                url: url,
            }) 
    ...
    return(
        <section ref={qrRef} className="relative flex flex-col items-center justify-center gap-y-10 h-screen w-screen">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 text-[#F2F5F9]">
                ...
                { ismobile ? (
                    <button onClick={shareQRcode} className="flex items-center gap-2 bg-[#3662E3] py-2 px-5 rounded-xl">Share <svg xmlns="http://www.w3.org/2000/svg" className=" size-5 icon icon-tabler icon-tabler-link" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 15l6 -6" /><path d="M11 6l.463 -.536a5 5 0 0 1 7.071 7.072l-.534 .464" /><path d="M13 18l-.397 .534a5.068 5.068 0 0 1 -7.127 0a4.972 4.972 0 0 1 0 -7.071l.524 -.463" /></svg> </button>
                ) : (
